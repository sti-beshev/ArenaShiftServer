...
public class ClientUserManagerTest {
	...
	@Before
	  ...
	  public void addClientUserTest() throws EntityNotFoundException {
		  ...
		  ServerResponseMessage<String> serverResponseMessage = clientUserManager.addClientUser(new WorkerInfo(username, label, isWorking));
	  ...
	  public void addClientUserUsernameExistTest() {
		  ...
		  clientUserManager.addClientUser(new WorkerInfo(username, label, true));
		  
		  // Trying to add the same username
		  ServerResponseMessage<String> serverResponseMessage = clientUserManager.addClientUser(new WorkerInfo(username, label, true));
	  ...
	  public void addClientUserEmptyUsername() {
		  ...
		  clientUserManager.addClientUser(new WorkerInfo("", "visitor", true));
	  }
}
