...
directivesModule.controller('PeopleSelectorController', ['$scope', '$http', '$q', function($scope, $http, $q) {
	...
	$scope.peopleSelector.kasierky = ["Анелия", "Багряна", "Гергана", "Голямата Катя", "Елица", "Малката Катя", "Наталия","Цветелина", "Боби"];
	$scope.peopleSelector.kasierkyTreta = ["няма", "Анелия", "Багряна", "Гергана", "Голямата Катя", "Елица", "Малката Катя", "Наталия","Цветелина", "Боби"];
